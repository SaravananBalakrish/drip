...
class NodeList extends StatelessWidget {
  const NodeList({super.key, required this.customerId, required this.userId, required this.controllerId, required this.deviceId, required this.deviceName, required this.lastSyncDate, required this.nodeList});
  final int userId, controllerId, customerId;
  final String deviceId, deviceName, lastSyncDate;
  // final List<NodeDataList> nodeList;
...
/*SizedBox(
                      ...
                      child: IconButton(
                        ...
                        icon: Icon(Icons.format_list_numbered, color: getPermissionStatusBySNo(context, 7)? Theme.of(context).primaryColorDark : Colors.black26),
...
/*
                    ...
                    SizedBox(
                      ...
                      child: IconButton(
                        ...
                        icon: Icon(Icons.network_check, color: getPermissionStatusBySNo(context, 8)? Theme.of(context).primaryColorDark:Colors.black26),
                    ...
                    itemBuilder: (context, index) {
                      return ExpansionTile(
                        ...
                        trailing: Row(
                          ...
                          children: [
                            nodeList[index].rlyStatus.any((rly) => rly.status == 2 || rly.status == 3)? const Icon(Icons.warning, color: Colors.orangeAccent):
                            const Icon(Icons.info_outline,),
                            IconButton(
                              onPressed: () {
                                showEditProductDialog(context, nodeList[index].deviceName, nodeList[index].controllerId, index);
                              },
                        ...
                        title: Row(
                          children: [
                            SizedBox(width: 30, child: Text('${nodeList[index].serialNumber}', style: const TextStyle(fontSize: 13),)),
                            SizedBox(
                              width:50,
                              child: Center(child: CircleAvatar(radius: 7, backgroundColor:
                              nodeList[index].status == 1? Colors.green.shade400:
                              nodeList[index].status == 2? Colors.grey:
                              nodeList[index].status == 3? Colors.redAccent:
                              nodeList[index].status == 4? Colors.yellow:
                              Colors.grey,
                              )),
                            ),
                            SizedBox(width: 40, child: Center(child: Text('${nodeList[index].referenceNumber}', style: const TextStyle(fontSize: 13),))),
                            SizedBox(
                              width: 142,
                              child: Column(
                                ...
                                mainAxisAlignment: MainAxisAlignment.end,
                                children: [
                                  Text(nodeList[index].deviceName, style: const TextStyle(fontWeight: FontWeight.normal, color: Colors.black, fontSize: 13)),
                                  Text(nodeList[index].deviceId, style: const TextStyle(fontWeight: FontWeight.normal,fontSize: 11, color: Colors.black)),
                                  RichText(
                                    text: TextSpan(
                                      children: <TextSpan>[
                                        TextSpan(text: '${nodeList[index].categoryName} - ', style: const TextStyle(fontWeight: FontWeight.normal,fontSize: 10, color: Colors.black)),
                                        TextSpan(text: mapInterfaceType(nodeList[index].interface), style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 10, color: Colors.black),),
                                      ],
                                    ),
                                  ),
                                ],
                        ...
                        children: [
                          SizedBox(
                            ...
                            height: calculateDynamicHeight(nodeList[index])+20,
                            child: Column(
                              ...
                              children: <Widget>[
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        const Spacer(),
                                        Text(
                                          'Total : ${nodeList[index].communicationCount.split(',').first}',
                                          style: const TextStyle(fontSize: 12),
                                        ),
                                        const SizedBox(width: 8,),
                                        Text(
                                          'Continuous : ${nodeList[index].communicationCount.split(',').last}',
                                          style: const TextStyle(fontSize: 12),
                                        ),
                                      ],
                                    ),
                                ...
                                ListTile(
                                  ...
                                  subtitle: Text(
                                    formatDateTime(nodeList[index].lastFeedbackReceivedTime),
...
/*if (nodeList[index].rlyStatus.isNotEmpty ||
  ...
  double calculateDynamicHeight(NodeDataList node) {
