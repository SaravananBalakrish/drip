...
import '../widgets/relay_status_avatar.dart';

class NodeListNarrow extends StatelessWidget {
  const NodeListNarrow({super.key, required this.customerId, required this.userId,
