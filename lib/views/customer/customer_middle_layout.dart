...
class CustomerMiddleLayout extends StatefulWidget {
  const CustomerMiddleLayout({super.key});

  @override
  State<CustomerMiddleLayout> createState() => _CustomerMiddleLayoutState();
}

class _CustomerMiddleLayoutState extends State<CustomerMiddleLayout> {
