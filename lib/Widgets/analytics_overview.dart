...
class AnalyticsOverview extends StatelessWidget {
  const AnalyticsOverview({super.key, required this.viewModel,
    required this.userId, required this.isWideScreen});
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      height: kIsWeb? screenWidth > 800 ? 360 : 425 : 550,
      child: Card(
        color: Colors.white,
  ...
  Widget buildHeader(BuildContext context, double screenWidth) {
    return (isWideScreen || screenWidth > 550) ? ListTile(
