...
class _VirtualMeterScreenState extends State<VirtualMeterScreen>
  ...
  Future<void> fetchData() async {
    ...
    try{
      ...
      var getUserDetails = await repository.getUservirtualwatermeter({
      ...
      if (getUserDetails.statusCode == 200) {
        setState(() {
          final jsondata1 = jsonDecode(getUserDetails.body);
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    MediaQuery.of(context).size.width >= 600
                        ? Expanded(child: buildFormulaEditorWidgetweb())
                        : Container()
      ...
      child: Padding(
        ...
        child: Container(
            ...
            child: DataTable2(
                ...
                fixedCornerColor:Theme.of(context).primaryColor,
                columnSpacing: 10,
                horizontalMargin: 10,
                minWidth: 800,
                decoration: BoxDecoration(
                ...
                fixedColumnsColor:
                    Selectindexrow == 0 ? Theme.of(context).primaryColor : Theme.of(context).primaryColor,
                columns: [
  ...
  bool checkboxvalassign(String formulastr, int srno, bool minplus) {
    if (formulastr != '') {
      ...
      if (MqttManager().isConnected == true) {
        await validatePayloadSent(
            ...
            acknowledgedFunction: () async{
              ...
              final Repository repository = Repository(HttpService());
              var getUserDetails = await repository.Updatevirtualwatermeter(body);
  ...
  )
  {
    ...
    for (var i = 0; i < data!.length; i++) {
      ...
      Mqttdata +=
          '${data[i]['sNo']},${data[i]['objectId']},${data[i]['name']},${data[i]['formula']},$protectionLimit,${data[i]['object'] == null || data[i]['object'] == '' ? '0' : data[i]['object']},$action,${data[i]['radio'] == null || data[i]['radio'] == '' ? '0' : data[i]['radio']};';
    }
    return Mqttdata;
  }
}
