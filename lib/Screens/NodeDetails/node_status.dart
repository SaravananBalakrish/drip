...
//                                             ]
//                                           };
//                                           await sentToServer('Set serial for all nodes comment sent', payLoadFinal);
...
//                                 ]
//                               };
//                               await sentToServer('Test Communication comment sent', payLoadFinal);
//                               await validatePayloadSent(
//                                   dialogContext: context,
//                                   context: context,
//                                   mqttPayloadProvider: payloadProvider,
...
//                                             ]
//                                           };
//                                           await sentToServer('Serial set for the ${payloadProvider.nodeData[index].deviceName} all Relay sent', payLoadFinal);
//                                           await validatePayloadSent(
//                                               dialogContext: context,
//                                               context: context,
//                                               mqttPayloadProvider: payloadProvider,
...
//   }
//
//   Future<void> sentToServer(String msg, dynamic payLoad) async
//   {
//     Map<String, Object> body = {"userId": overAllPvd.userId, "controllerId": overAllPvd.controllerId, "messageStatus": msg, "data": payLoad, "hardware": payLoad, "createUser": overAllPvd.userId};
