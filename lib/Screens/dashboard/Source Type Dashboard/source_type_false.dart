...
class SourceTypeDashBoardFalse extends StatefulWidget {
  final int active;
  final int selectedLine;
  final String imeiNo;
  const SourceTypeDashBoardFalse({super.key, required this.active, required this.selectedLine, required this.imeiNo});

  @override
  State<SourceTypeDashBoardFalse> createState() => _SourceTypeDashBoardFalseState();
}

class _SourceTypeDashBoardFalseState extends State<SourceTypeDashBoardFalse> with TickerProviderStateMixin{
