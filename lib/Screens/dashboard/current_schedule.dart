...
//                         child: ((payloadProvider.currentSchedule[payloadProvider.selectedCurrentSchedule]['Message'] == 'Running.' || payloadProvider.currentSchedule[payloadProvider.selectedCurrentSchedule]['ProgName'].contains('StandAlone')) && (overAllPvd.takeSharedUserId ?  (payloadProvider.userPermission[0]['status'] || payloadProvider.userPermission[1]['status']) : true))
//                             ? InkWell(
