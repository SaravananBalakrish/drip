...
class outletPumpDashBoardTrue extends StatefulWidget {
  final int active;
  final int selectedLine;
  final String imeiNo;
  const outletPumpDashBoardTrue({super.key, required this.active, required this.selectedLine, required this.imeiNo});

  @override
  State<outletPumpDashBoardTrue> createState() => _outletPumpDashBoardTrueState();
}

class _outletPumpDashBoardTrueState extends State<outletPumpDashBoardTrue> with TickerProviderStateMixin{
