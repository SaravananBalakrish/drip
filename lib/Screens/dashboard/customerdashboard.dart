        ...
        child: Row(
          ...
          children: [
            if(payloadProvider.currentSchedule.isNotEmpty)
              if(payloadProvider.selectedLine == 0 || payloadProvider.currentSchedule.map((cs) => cs['ProgCategory']).join('').contains(payloadProvider.lineData[payloadProvider.selectedLine]['id']) )
                InkWell(
                  onTap: (){
                    setState(() {
                      selectedTab = 0;
