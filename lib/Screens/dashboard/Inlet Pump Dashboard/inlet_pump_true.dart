...
class inletPumpDashBoardTrue extends StatefulWidget {
  ...
  final String imeiNo;
  const inletPumpDashBoardTrue({super.key, required this.active, required this.selectedLine, required this.imeiNo});

  @override
  State<inletPumpDashBoardTrue> createState() => _inletPumpDashBoardTrueState();
}

class _inletPumpDashBoardTrueState extends State<inletPumpDashBoardTrue> with TickerProviderStateMixin{
